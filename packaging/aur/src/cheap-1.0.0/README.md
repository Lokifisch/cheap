# Enchant Order (native)

A native, compiled desktop app for the Minecraft anvil-combining problem:
given a set of enchanted books to apply to an item, find the cheapest order
to combine them in the anvil, minimizing either total XP spent or the item's
